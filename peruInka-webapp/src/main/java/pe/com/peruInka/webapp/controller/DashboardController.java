...
public class DashboardController {
	...
	public String deleteHotel(Model model, HttpServletRequest request,@ModelAttribute("hotel") Hotel hotel){
		System.out.println("home/deleteHotel");
		
		peruInkaService.deleteHotel(hotel);
		
		return "redirect:dashboardHotel";
	}
